...
from chess_ai.data.lichess_api import get_games, get_games_as_a_set
from chess_ai.ml.tensor import ChessTensor
from chess_ai.paths import TRAINED_MODEL
...
def create_chess_cnn():
    model = tf.keras.Sequential(
        [
            ...
            layers.Conv2D(
                32, (3, 3), activation="relu", padding="same", input_shape=(8, 8, 70)
            ),
